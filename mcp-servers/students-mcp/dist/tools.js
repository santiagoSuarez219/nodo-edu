...
export const tools = [
    ...
    },
    {
        ...
        description: "Retira a un estudiante de un curso (deja la matrícula en estado 'withdrawn', no la borra). Para deshacer un retiro hecho por error, usa enroll_student con el mismo estudiante y curso: reactiva la matrícula existente en vez de crear una nueva.",
        inputSchema: {
            type: "object",
            properties: {
                id: { type: "string", description: "UUID del estudiante" },

...
export const tools = [
    {
        name: "list_questions",
        description: "Lista preguntas del banco con filtros opcionales. Úsala para explorar el banco antes de crear y evitar duplicados.",
        inputSchema: {
            type: "object",
            properties: {
                type: {
    ...
    },
    {
        ...
        description: "Actualiza una pregunta (envía campos a cambiar; el MCP relee y compone el payload completo). No cambia el type.",
        inputSchema: {
            type: "object",
            properties: {
                id: {
    ...
    },
    {
        ...
        description: "Publica una pregunta (is_published=true). La API valida ≥1 opción correcta en multiple_choice.",
        inputSchema: {
            type: "object",
            properties: {
                id: {
...
async function handleListQuestions(input) {
    ...
    if (input.tag)
        params.append("tag", String(input.tag));
    if (input.q)

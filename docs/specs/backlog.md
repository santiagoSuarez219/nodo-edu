...
## DEBT-082 — Planilla de asistencia: marcado masivo por columna
...
## DEBT-081 — Planilla de asistencia: exportar a CSV
...
## DEBT-080 — Exponer `marked_by` (procedencia del marcado) en `get_session_attendance` del MCP
...
## DEBT-079 — El % de asistencia penaliza al estudiante matriculado tarde
...
## DEBT-078 — Quitar la columna "Fecha matrícula" de `EnrollmentTable.tsx`

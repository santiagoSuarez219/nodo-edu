...
| [07](./semana-07.md) | 14–20 sep (AA) · 17 sep (PC) | `feat/semana-07-08-analisis-de-algoritmos` (borrada) · `feat/semana-07-programacion-cientifica` (borrada) | AA: **desplegada y abierta en producción** · PC: mergeada a `development` (pendiente despliegue) |

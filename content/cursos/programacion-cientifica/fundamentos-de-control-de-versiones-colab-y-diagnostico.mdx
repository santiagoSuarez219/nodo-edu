...
**GitHub** es la plataforma en la nube donde vas a guardar cada notebook que produzcas en este curso, de forma que quede accesible desde cualquier computador y visible para tu docente. Cada vez que subes una versión, GitHub la conservas

...
## El problema: ¿existe una relacion entre `Cliente` y `Cuenta`?
...
UML distingue tres relaciones según qué tan atado está el ciclo de vida de un objeto al del otro: si solo se conocen, si uno reúne al otro sin poseerlo, o si uno no tiene sentido sin el
otro.

Las tres se dibujan como una línea entre dos clases, pero la punta que toca
al "todo" cambia: una flecha simple, un diamante hueco, un diamante relleno. Esa punta es la única diferencia visual — y encierra una decisión de diseño completa.

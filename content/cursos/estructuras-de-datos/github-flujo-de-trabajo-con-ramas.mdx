...
**Situación:** tu compañero de equipo va a implementar el módulo de `service/` mientras tú trabajas en `view/`. Si los dos editan directamente sobre la única copia de código que existe, cualquier error de uno bloquea el trabajo del otro — y si algo se rompe, no hay forma limpia de aislar quién dañó qué.

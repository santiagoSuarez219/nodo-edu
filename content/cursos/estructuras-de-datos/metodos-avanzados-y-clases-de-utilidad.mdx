...
summary: "Sobrecarga de métodos, atributos y métodos static, y la diferencia entre == y equals en String e Integer, sobre la clase Cuenta del sistema bancario."

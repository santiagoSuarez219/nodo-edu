...
`Cliente "1" *-- "1..*" Cuenta` es composición: el diamante relleno del
...
de cada subtipo, y al correr este `main` vas a ver dos mensajes con
distinto comportamiento aunque la llamada (`cuenta.retirar(30000)`) sea
idéntica en las dos.

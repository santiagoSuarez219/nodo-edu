...
Guarda bien estas cinco clases: no son un ejercicio aislado. En el
laboratorio evaluativo de la Semana 4 (Momento 1) las retomas y las
extiendes con encapsulamiento, herencia e interfaces, así que conviene
llegar con todo commiteado y funcionando.

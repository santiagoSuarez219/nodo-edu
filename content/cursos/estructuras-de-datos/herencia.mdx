...
summary: "Superclases y subclases con extends, atributos protected, super() en el constructor y sobreescritura de métodos con @Override, aplicados a Tarjeta, TarjetaDebito y TarjetaCredito del proyecto de aula."

...
razón `n / log₂ n` es de casi 43 veces menos operaciones, y la brecha crece
con `n`.
...
**Situación:** al margen del subarreglo máximo, la empresa también necesita
propagar coeficientes de calibración entre estaciones de medición mediante
multiplicación de matrices grandes. El algoritmo escolar —tres bucles

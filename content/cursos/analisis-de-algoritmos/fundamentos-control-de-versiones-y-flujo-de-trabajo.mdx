...
Está escrito en **Markdown** (de ahí la extensión `.md`), el mismo lenguaje de formato liviano que usas para tus informes de laboratorio.
...
<YouTubeEmbed id="akuG7eRtaXc" title="Cómo configurar claves SSH para Git y GitHub" />

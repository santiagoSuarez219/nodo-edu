...
export default async function LessonLayout({
  ...
  return (
    <main className="flex-1 bg-white dark:bg-gray-900 w-full  px-4 md:px-6 lg:px-0 py-6 lg:py-10">
      <div className="lg:grid lg:grid-cols-[280px_1fr] lg:gap-10">
        <aside className="hidden lg:block lg:sticky lg:top-24 lg:h-[calc(100vh-theme(spacing.32))] lg:overflow-y-auto rounded-lg border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 p-3">
          <LessonSidebar
            course={course}

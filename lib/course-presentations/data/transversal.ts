...
export const TRANSVERSAL_INSTRUCTOR: Instructor = {
  name: "Santiago Suarez Cortes",
  credentials:
    "Ingeniero Electrónico, Candidato a Magíster en Automatización y Control Industrial",
  department: "Facultad de Ingenierias / Departamento de Sistemas",
  researchGroup: "Maquinas Inteligentes y Reconocimiento de Patrones (MIRP)",
  email: "santiagosuarez9056@correo.itm.edu.co",
  office: "Campus Fraternidad - Bloque K - Oficina 102",
};

export const TRANSVERSAL_CONDITIONS = [

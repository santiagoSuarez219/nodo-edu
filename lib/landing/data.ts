...
export const LANDING_COURSES: LandingCourse[] = [
  {
    ...
    level: 'Intermedio',
    hours: 40,
    description: 'Aprende las estructuras fundamentales: listas, árboles, grafos y más.',
    progress: 60,
  },
  {
    id: 'algoritmos',
    ...
    level: 'Avanzado',
    hours: 45,
    description: 'Domina los algoritmos clásicos de ordenamiento, búsqueda y optimización.',
    progress: 35,
  },
  {
    id: 'python-fund',
    ...
    level: 'Básico',
    hours: 30,
    description: 'Comienza con Python: sintaxis, tipos de datos y control de flujo.',
    progress: 85,
  },
  {
    id: 'ml-basico',
...
export const ROADMAP_STEPS: RoadmapStep[] = [
  {
    ...
    description: 'Explora nuestro catálogo y selecciona el curso que se ajuste a tu nivel.',
  },
  {
    number: 2,
    title: 'Aprende a tu ritmo',
    description: 'Accede a las lecciones cuando quieras, desde cualquier dispositivo.',
  },
  {
    number: 3,

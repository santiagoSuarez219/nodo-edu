...
export type MarkLessonCompletedResult =
  ...
  | {
      ...
      reason:
        ...
        // spec-039: la lección está deshabilitada por el docente.
        | "lesson_disabled"
        // spec-039 (D6): no se pudo verificar la disponibilidad — fallar
        // cerrado, distinto de "lesson_disabled" para no mentir.
